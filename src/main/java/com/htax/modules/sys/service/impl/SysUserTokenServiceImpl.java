...
import com.htax.common.utils.RedisUtils;
import com.htax.modules.sys.dao.SysUserTokenDao;
import com.htax.modules.sys.entity.SysUserTokenEntity;
import com.htax.modules.sys.oauth2.TokenGenerator;
import com.htax.modules.sys.service.SysUserTokenService;
...
public class SysUserTokenServiceImpl extends ServiceImpl<SysUserTokenDao, SysUserTokenEntity> implements SysUserTokenService {
	...
	public R createToken(long userId) {
		...
		// redisUtils.set(userId+"",token,EXPIRE);
		return r;
	}
